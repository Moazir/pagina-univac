...
var swiper = new Swiper(".mySwiper-1",{
    ...
    function cargarEventListeners(e){
        ...
        vaciarCarritoBtn.addEventListener('click', comprarElemento);
    }
    ...
    function leerDatosElemento(elemento){
        const infoElemento = {
            ...
            precio: elemento.querySelector('a').getAttribute('data-ic'),
    ...
    function insertarCarrito(elemento){
        ...
        <td>
        <a href="#" class="borrar" data-id="${elementos.id}">
        </td>
        `;
    ...
    function eliminarElemento(e){
        ...
        if(e.target.classList.contains(`borrar`)){
            ...
            elemento = e-targetElement.parentElement.remove();
